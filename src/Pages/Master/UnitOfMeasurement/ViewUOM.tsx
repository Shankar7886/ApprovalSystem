...
const ViewUOM = ({ closePopup, open, data }: ViewUOMProps) => {
  const UOMDetails = Object.entries(data).map(([key, value], _) => ({
    title: key,
              ...
              {UOMDetails.map((item, index) => (
                ...
                >
                  ...
                  <span className="text-base font-medium text-gray-800 break-words">
                    {["DOB", "DOJ", "CreatedOn", "UpdatedOn"].indexOf(
                      item.title
                    ) > -1
